...
/** ICAL.Time → ISO-Konvention dieses Plugins (s. Plan Task 8). tzid kommt notfalls aus dem übergebenen Property-Parameter. */
...
function timeOfProp(p: ICAL.Property): { iso: string; tzid?: string } {
