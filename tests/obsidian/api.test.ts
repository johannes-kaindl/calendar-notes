...
function eventRenameDescriptor(withInvite = false): CommandDescriptor {
  return {
    ...
    kind: "event",
    title: "Titel ändern",
    titleKey: "test.event.rename.title",
    description: "Ändert den Titel eines Termins",
    descriptionKey: "test.event.rename.desc",
    ...
    plan(input, ctx) {
      ...
      const plan: ReturnType<CommandDescriptor["plan"]> = {
        ...
        summaryKey: "test.event.rename.summary",
        summaryArgs: [title],
...
function eventCreateDescriptor(): CommandDescriptor {
  return {
    ...
    kind: "event",
    title: "Neuer Termin",
    titleKey: "test.event.create.title",
    description: "Legt einen Termin an",
    descriptionKey: "test.event.create.desc",
    schema: { type: "object", properties: { title: { type: "string" } }, required: ["title"] },
    ...
    plan(input, ctx) {
      ...
      return {
        ...
        summaryKey: "test.event.create.summary",
        summaryArgs: [title],
        diff: [],
