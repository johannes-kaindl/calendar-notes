...
- [ ] **Step 2: tsconfig.json, tsconfig.test.json, vitest.config.ts, esbuild.config.mjs**
...
- [ ] **Step 3: manifest.json, versions.json, styles.css, LICENSE, tests-Setup**
...
- [ ] **Step 4: Template-Dateien kopieren + check-pure + sync-kit**
...
- [ ] **Step 5: Plugin-Stub + Smoke-Test, Install, alles grün**
...
- [ ] **Step 6: AGENTS.md + CHANGELOG.md, Commit**
...
- [ ] **Step 3: Rot sehen** — `npx vitest run tests/core/dav/xml.test.ts` → FAIL.
...
- [ ] **Step 2: Rot sehen** — `npx vitest run tests/core/dav/requests.test.ts` → FAIL.
...
- [ ] **Step 2: Rot sehen** — `npx vitest run tests/core/dav/discovery.test.ts` → FAIL.
...
- [ ] **Step 2: Rot sehen** — `npx vitest run tests/core/dav/sync.test.ts` → FAIL.
...
- [ ] **Step 3: Rot sehen** — `npx vitest run tests/core/ical` → FAIL.
...
- [ ] **Step 3: Rot sehen** — `npx vitest run tests/core/vcard` → FAIL.
...
- [ ] **Step 1: Radicale-Fixture anlegen**
...
- [ ] **Step 4: Laufen lassen, Radicale-Eigenheiten einarbeiten**
